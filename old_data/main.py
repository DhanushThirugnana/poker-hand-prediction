...
def submit_spark_app(master, appName, host, port, interval, path_test_data, rdd_list):
    ...
    #This function trains and predicts the data.
    # file = open("testfile.txt", 'w+')
    # file.write(str(model.kfolds(rdd_list)))
    # file.close()
    model.kfolds(rdd_list)
...
if __name__ == '__main__':
    ...
    #logging.getLogger("requests").setLevel(level.OFF)
